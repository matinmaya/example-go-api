...
type TokenInfo struct {
	...
	ExpiresAt    basemodel.TDateTime `json:"expires_at" gorm:"not null;index"`
	CreatedAt    basemodel.TDateTime `json:"created_at"`
	UpdatedAt    basemodel.TDateTime `json:"updated_at"`
}
...
type AuthLoginResource struct {
	...
	ExpiresAt    basemodel.TDateTime `json:"expires_at"`
}
