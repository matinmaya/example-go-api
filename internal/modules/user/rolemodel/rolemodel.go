...
type Role struct {
	...
	Name          basemodel.TString      `json:"name" gorm:"unique;not null;type:varchar(50);" validate:"required,max=50,unique=sys_roles?id"`
...
type RoleListQuery struct {
	...
	Name   basemodel.TString `form:"name" filter:"like"`
